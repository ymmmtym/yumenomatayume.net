export default function Header({ pathname }: { pathname: string }) {
  ...
  return (
    <header class="flex justify-between items-center mb-8 py-4 px-4 bg-gradient-to-r from-purple-900 to-indigo-900 dark:from-purple-50 dark:to-pink-50 border-b border-purple-700 dark:border-purple-200">
      <div class="w-10"></div>
