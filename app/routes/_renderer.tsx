  ...
  return (
    <html lang="ja">
      <head>
        ...
        {/* Fuse.js CDN for search */}
        <script src="https://cdn.jsdelivr.net/npm/fuse.js@7.0.0/dist/fuse.min.js" async />
