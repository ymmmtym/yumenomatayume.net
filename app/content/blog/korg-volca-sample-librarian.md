...
![volca_sample_Updater](https://res.cloudinary.com/yumenomatayume/image/upload/f_auto,q_auto/v1/yumenomatayume.net/volca-sample-updater?_a=BAMAMiFE0)
...
![volca_sample_Librarian_Install](https://res.cloudinary.com/yumenomatayume/image/upload/f_auto,q_auto/v1/yumenomatayume.net/volca-sample-librarian-install?_a=BAMAMiFE0)

その後、volca sample2 本体を USB に繋いだ状態でアプリを立ち上げます。
初回起動時は volca sample2 にデフォルトで入っているパターン・データとサンプル・データが表示されます。

![volca_sample_Librarian_Top](https://res.cloudinary.com/yumenomatayume/image/upload/f_auto,q_auto/v1/yumenomatayume.net/volca-sample-librarian-top?_a=BAMAMiFE0)

![volca_sample_Librarian](https://res.cloudinary.com/yumenomatayume/image/upload/f_auto,q_auto/v1/yumenomatayume.net/volca-sample-librarian?_a=BAMAMiFE0) |
